...
float wpth1[3][4] = {{0,9,0,0},{3,22,0,0},{0,0,99,0}};
int wpth2[3][4] = {{106,0,0,0},{76,0,0,0},{4,175,0,17}};
int num_waypoints = 4;
...
task main()
{
	...
	for(int j = 0; j<3; j++)
	{
		...
		{
			int goalth1 = wpth1[j][i]+nMotorEncoder[joint1];
			...
			while(errorth1 !=  0 || abs(errorth2) != 0)
			{
				...
				int feedforwardJ1 = cos(nMotorEncoder[joint1])*7;
				...
				nxtDisplayCenteredTextLine(3, "Error: %d", errorth1);
				nxtDisplayCenteredTextLine(4, "Joint1: %d", nMotorEncoder[joint1]);
